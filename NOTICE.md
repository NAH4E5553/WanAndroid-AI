...
2026-09-13 登录会话阶段只读参考同一当前商城版本 0e6a9aa4a10d4c8139f1eb0455db3a826c99657e（MIT/Joker.X）：feature/auth/viewmodel/AccountLoginViewModel 与 core/network/interceptor/AuthInterceptor 的分层职责作为参考。本项目使用 WanAndroid 用户名表单和 Cookie 会话，不沿用商城手机号规则、Token 协议或密码持久化；新增会话代次隔离、Keystore 加密、恢复验证与取消保护。
